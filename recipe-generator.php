...
// Autoloader simulation (without Composer)
// spl_autoload_register(function ($class) {
//     $prefix = 'Recipe_Generator_';
//     $base_dir = RECIPE_GENERATOR_PATH . 'includes/';
    
//     if (strpos($class, $prefix) !== 0) {
//         return;
//     }
    
//     $file = $base_dir . 'class-' . strtolower(str_replace(array($prefix, '_'), array('', '-'), substr($class, strlen($prefix)))) . '.php';
